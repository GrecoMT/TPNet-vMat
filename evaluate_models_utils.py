...
def evaluate_model_link_prediction(model_name: str, model: nn.Module, neighbor_sampler: NeighborSampler,
                                   ...
                                   random_projections: RandomProjectionModule = None):
    """
    ...
    :param random_projections: RandomProjectionModule, the module to maintain the temporal walk matrices
    :return:
    """
    ...
    if model_name == 'NAT':
        # reset the random state of NAT for reproducibility
    ...
    with torch.no_grad():
        ...
        for batch_idx, evaluate_data_indices in enumerate(evaluate_idx_data_loader_tqdm):
            ...
            if random_projections is not None:
            ...
            evaluate_metrics.append(get_link_prediction_metrics(predicts=predicts.sigmoid(), labels=labels))
